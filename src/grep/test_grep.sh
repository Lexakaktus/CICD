...
for var1 in v c l i h  n # 7 из 10
do  
    var="0 -$var1"
    testing "$var"
done
...
for var1 in v c l i h  n
do  
    for var2 in v c l i h  n
    do  
        if [ $var1 != $var2 ]
        then
            var="0 -$var1 -$var2"
...
for var1 in "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/1.txt" "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/2.txt"
do  
    var="-f $var1"
    testing "$var"
done
...
for var1 in "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/1.txt" "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/2.txt"
do
    for var2 in "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/3.txt" "/Users/ezrealtr/C3_SimpleBashUtils-1/src/grep/testsfiles/4.txt"    
    do  
        var="-f $var1 -f $var2"
        testing "$var"
    done
